...
Rails.application.config.assets.precompile += %w( simple_nav.css )
Rails.application.config.assets.precompile += %w( simple_nav.js )
Rails.application.config.assets.precompile += %w( cv/index.css )
